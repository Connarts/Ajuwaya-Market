...
<div class="header">
	...
	<div class="banner text-center">
	  <div class="container">    
			...
			<p>We sell anything sellable here</p>
		...
		<div class="container">
			<div class="select-box">
				<div class="select-city-for-local-ads ads-list">
					<label>Select your city to see local adverts</label>
						<select>
												<optgroup label="Popular Cities">
													<option selected style="display:none;color:#eee;">Entire NIGERIA</option>
													<option>Abia</option>
													<option>Adamawa</option>
													<option>Akwa Ibom</option>
													<option>Anambra</option>
						   ...
						   <div>
							...
							<ul class="list">
								<a href="single.html">
									...
									<h5 class="title">There are various prices here</h5>
